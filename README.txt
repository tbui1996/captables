...
This library allows for importing csv files, data aggregation, and outputting to json format. I follow Bob Martin’s Clean Code methodology where functions are less than 7 lines and with no comment explaining what the code does. The descriptive variables and function names should be self-explanatory to any software engineer. 
